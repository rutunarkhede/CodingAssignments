...
var dollarValue = document.getElementById('euros');

document.getElementById('mybet').onchange = function() {
  if (this.value < 0) {
    this.value = 0;
  }
  if (this.value > myeuros) {
    this.value = myeuros;
  }
...
function dealNew() {
  ...
  myeuros = myeuros - betvalue;
  document.getElementById('euros').innerHTML = myeuros;
...
function cardAction(a) {
  ...
  switch (a) {
    ...
    case 'double':
      ...
      if ((myeuros - betvalue) < 0) {
        betvalue = betvalue + myeuros;
        myeuros = 0;
      } else {
        myeuros = myeuros - betvalue;
        betvalue = betvalue * 2;
